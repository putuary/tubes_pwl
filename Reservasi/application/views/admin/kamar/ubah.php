                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center"><?= $detail->jenis ?></h3>
                                        </div>
                                        <hr>
                                        <form action="<?=site_url('Kamar/update/'.$detail->id)?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="<?=$detail->id?>">
                                                ...
                                                <div>
                                                     <input name="simpan" id="payment-button" type="submit" class="btn btn-lg btn-primary btn-block" value="Simpan">
                                                </div>
                                        </form>
                                    </div>
                                </div>
