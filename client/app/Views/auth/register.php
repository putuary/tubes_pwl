                ...
                <div class="jumbotron">
                    ...
                    <form action="<?= current_url() ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" id="first_name" class="form-control <?= $validation && $validation->hasError('first_name') ? 'is-invalid' : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="last_name" id="last_name" class="form-control <?= $validation && $validation->hasError('last_name') ? 'is-invalid' : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" class="form-control <?= $validation && $validation->hasError('email') ? 'is-invalid' : '' ?>">
